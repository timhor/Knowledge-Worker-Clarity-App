...
public class Learning {
    ...
    private StringProperty learningDate;
    ...
    public Learning(String id, String categoryColour, String categoryName, String description, String date, String startTime, String endTime) {
        this.id = id;
